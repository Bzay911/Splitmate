...
const InviteMatesBtn: React.FC<InviteMatesBtnProps> = ({ groupId }) => {
  ...
  const handleInviteUser = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Success",
        data.message || "User has been added to the group successfully",
        [
          {
            text: "OK",
            onPress: async () => {
    ...
    <SafeAreaView>
      <View style={styles.inviteSection}>
        <View style={styles.titleContainer}>
          ...
          <TouchableOpacity style={styles.infoButton} onPress={showInviteInfo}>
            <Text style={styles.inviteText}>How to invite?</Text>
          </TouchableOpacity>
        </View>
        <TextInput
